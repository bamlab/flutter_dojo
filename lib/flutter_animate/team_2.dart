...
class FlutterAnimateTeam2 extends StatefulWidget with TeamMixin {
  final teamName = 'Team2';

  @override
  State<FlutterAnimateTeam2> createState() => _FlutterAnimateTeam2State();
}

class _FlutterAnimateTeam2State extends State<FlutterAnimateTeam2> {
  @override
