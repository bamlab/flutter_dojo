...
class Blockudoku2Team2 extends StatefulWidget with TeamMixin {
  final teamName = 'Team2';

  @override
  State<Blockudoku2Team2> createState() => _Blockudoku2Team2State();
}

class _Blockudoku2Team2State extends State<Blockudoku2Team2> {
  @override
