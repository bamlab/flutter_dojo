...
class Blockudoku2Team3 extends StatefulWidget with TeamMixin {
  final teamName = 'Team3';

  @override
  State<Blockudoku2Team3> createState() => _Blockudoku2Team3State();
}
...
class _Blockudoku2Team3State extends State<Blockudoku2Team3> {
  @override
